...
if False:
    alltimes = np.array(data.loc[data['Bell No'] == 3]['Actual Time'])
    alltimes[1:] = alltimes[:-1]
    alltimes[0] = 0.0

    data.loc[data['Bell No'] == 3, 'Actual Time'] = alltimes
    data = data.sort_values('Actual Time')
    data = data.iloc[23:-1]
